...
public final class Paper261SynchedDataBuilder {
    ...
    private Paper261SynchedDataBuilder() {
    }

    public static Paper261SynchedDataBuilder builder() {
        return new Paper261SynchedDataBuilder();
    }

    public <T> Paper261SynchedDataBuilder setDataItem(EntityDataAccessor<T> accessor, T defaultValue) {
