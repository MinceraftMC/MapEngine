...
public final class Paper12111SynchedDataBuilder {
    ...
    private Paper12111SynchedDataBuilder() {
    }

    public static Paper12111SynchedDataBuilder builder() {
        return new Paper12111SynchedDataBuilder();
    }

    public <T> Paper12111SynchedDataBuilder setDataItem(EntityDataAccessor<T> accessor, T defaultValue) {
